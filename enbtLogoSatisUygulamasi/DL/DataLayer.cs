...
namespace enbtLogoSatisUygulamasi.DL
{
    public static class DataLayer
    {
        ...
        public static int MüşteriEkle(Musteri m)
        {
            ...
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("enbtlogo_MusteriEkle", conn);
        ...
        internal static int MüşteriGüncelle(Musteri m)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("enbtlogo_MusteriGuncelle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@id", m.ID);
                komut.Parameters.AddWithValue("@ad", m.Ad);
        ...
        internal static int UrunSil(string id)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("enbtlogo_UrunSil", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@id", id);
        ...
        internal static int SatisSil(string id)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("enbtlogo_SatisSil", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@id", id);
        ...
        internal static int UrunGüncelle(Logo u)
        {
            try
            {
                if (conn.State != System.Data.ConnectionState.Open)
                ...
                MySqlCommand komut = new MySqlCommand("enbtlogo_UrunGuncelle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@id", u.ID);
                komut.Parameters.AddWithValue("@tipi", u.Tipi);
                komut.Parameters.AddWithValue("@boyutu", u.Boyutu);
                komut.Parameters.AddWithValue("@adet", u.Adet);
                komut.Parameters.AddWithValue("@rengi", u.Rengi);
                komut.Parameters.AddWithValue("@arkaplani", u.Arkaplani);
        ...
        internal static DataSet MüşteriGetir(string filtre)
        {
            try
            {
                ...
                {
                    komut = new MySqlCommand("enbtlogo_MusterilerHepsi", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
                }
                else
                {
                    komut = new MySqlCommand("enbtlogo_MusteriBul", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static int UrunEkle(Logo u)
        {
            try
            {
                if (conn.State != System.Data.ConnectionState.Open)
                ...
                MySqlCommand komut = new MySqlCommand("enbtlogo_UrunEkle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@id", u.ID);
                komut.Parameters.AddWithValue("@tipi", u.Tipi);
                komut.Parameters.AddWithValue("@boyutu", u.Boyutu);
        ...
        internal static DataSet UrunGetir(string filtre)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(filtre))
                {
                    komut = new MySqlCommand("enbtlogo_UrunlerHepsi", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
                }
                else
                {
                    komut = new MySqlCommand("enbtlogo_UrunBul", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
                    komut.Parameters.AddWithValue("@filtre", filtre);
                }
        ...
        internal static int SatisEkle(Satis s)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("enbtlogo_SatisEkle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@sid", s.ID);
                komut.Parameters.AddWithValue("@mid", s.MusteriID);
                komut.Parameters.AddWithValue("@uid", s.LogoID);
        ...
        internal static int OdemeEkle(Odeme o)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("enbtlogo_OdemeEkle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static int OdemeGüncelle(Odeme o)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("enbtlogo_OdemeGuncelle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@oid", o.ID);
                komut.Parameters.AddWithValue("@mid", o.MusteriID);
                komut.Parameters.AddWithValue("@tarih", o.Tarih);
        ...
        internal static int SatisGüncelle(Satis s)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("enbtlogo_SatisGuncelle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@sid", s.ID);
                komut.Parameters.AddWithValue("@mid", s.MusteriID);
                komut.Parameters.AddWithValue("@uid", s.LogoID);
        ...
        internal static DataSet SatisDeyat()
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("enbt_SatisDetay", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static DataSet OdemeDetay()
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("enbtlogo_OdemeDetay", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static int OdemeSil(string id)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("enbt_OdemeSil", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
